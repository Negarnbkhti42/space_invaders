...
public class Assets {
    ...
    public static final SpriteSheet aliens = new SpriteSheet(ImageLoader.loadImage("/res/space_invader_sprites2.png"));
    public static final BufferedImage laser=ImageLoader.loadImage("/res/SpaceInvadersLaserDepiction.png");
